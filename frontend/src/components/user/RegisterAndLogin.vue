...
<template>
  ...
  <div
    ...
    class="bg-white flex flex-row items-center justify-center px-10 mt-[100px]"
  >
    <div
      class="w-full bg-[#796254] text-white rounded-2xl p-8 max-w-md [box-shadow:inset_0px_10px_20px_rgba(0,0,0,0.5),0px_10px_20px_rgba(0,0,0,0.5)]"
    >
      ...
      <form class="space-y-6">
        ...
        <div class="space-y-1">
          <label
            for="password"
            class="block text-[20px] font-semibold text-white"
            >Password</label
          >
          <div class="w-full h-full relative">
            ...
            <div
              ...
              class="absolute top-0 right-2 cursor-pointer h-full flex justify-center items-center"
            >
              <svg
                v-if="isShowPassword"
              ...
              >
                <path
                  fill="#000000"
                  d="M41.56 26.13a1.251 1.251 0 0 0 1.57.81c.65-.21 1.02-.91.81-1.57l-.001-.003C43.85 25.1 38.841 10 23.999 10C9.16 10 4.15 25.1 4.062 25.367l-.001.003c-.21.66.15 1.36.81 1.57c.66.21 1.36-.15 1.57-.81c.18-.56 4.51-13.63 17.56-13.63c13.05 0 17.38 13.07 17.56 13.63ZM24 36a9 9 0 1 0 0-18a9 9 0 0 0 0 18Z"
                />
              </svg>
              <svg
                v-if="!isShowPassword"
        ...
        <div class="space-y-1">
          ...
          >
            <option disabled selected value="">Select your types</option>
            <option
    ...
    <div
      v-if="isSeller"
      class="w-full h-full bg-[#796254] text-white rounded-2xl shadow-xl p-8 max-w-md [box-shadow:inset_0px_10px_20px_rgba(0,0,0,0.5),0px_10px_20px_rgba(0,0,0,0.5)]"
    >
      <form class="space-y-6">
        <div class="space-y-1">
          <label
  ...
  >
    <div
      class="bg-[#796254] text-white rounded-2xl shadow-xl p-8 w-full max-w-md"
    >
      <div class="text-center mb-8">
      ...
      <div
        v-show="props.is401 || props.is400 || props.is403"
        class="itbms-message mb-3"
      >
