        ...
        <div class="w-full h-[80px] flex justify-center items-center">
            <button class="flex justify-start items-center border border-gray-300 w-[80%] h-full rounded-lg overflow-x-auto cursor-pointer hover:border-gray-500">
                <div class="flex flex-row space-x-3 px-2">
                    <div v-for="(brand, index) in filterBrand" :key="index" class="flex flex-row items-center bg-gray-100 border border-gray-300 rounded-lg px-2 py-1 space-x-2">
                        <span class="text-sm text-gray-700">{{ brand }}</span>
                        <svg @click="deleteBrand(index)" xmlns="http://www.w3.org/2000/svg" 
            ...
            <button @click="isDropFilterBrand = !isDropFilterBrand" class="bg-gray-400 rounded-lg h-[40px] ml-3 cursor-pointer hover:opacity-80">
            ...
            <button @click="clearFilterBramd" class="bg-gray-400 rounded-lg w-[10%] h-full ml-3 cursor-pointer hover:opacity-80">
                Clear
            </button>
        </div>
