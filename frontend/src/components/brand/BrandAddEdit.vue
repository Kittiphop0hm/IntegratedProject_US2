...
<template>
  ...
  <div class="px-2 py-10 w-full min-h-screen flex justify-center items-center bg-gray-100">
    <div class="w-full h-full flex flex-col items-center justify-center">
      <div class="w-full flex justify-around items-center py-5">
        <div>
          <p>
            <router-link
              to="/sale-items/list"
              class="itbms-item-list text-black hover:underline font-medium"
              >Sale item List</router-link
            >
            >
            <router-link
              to="/brands"
              class="itbms-manage-brand text-black hover:underline font-medium"
              >Brand List</router-link
            >
            >
            <span class="font-medium text-[#523F31]"
              >{{ isAdd ? "Add Brand" : "Edit Brand" }}</span
            >
          </p>
        </div>
      </div>
      ...
      <div class="w-full flex justify-center">
        <div
          class="w-[50%] h-auto max-w-lg p-6 bg-white border border-gray-300 rounded-2xl shadow-md max-md:w-full"
        >
          <form
            @submit.prevent="!isAdd ? editBrand() : addBrand()"
            class="flex flex-col justify-center gap-4"
          >
            <h2 class="text-2xl font-semibold text-center mb-4">
              {{ isAdd ? "Add New Brand" : "Edit Brand" }}
            </h2>

            <div class="flex flex-col">
              <label for="brandName" class="text-sm font-semibold mb-1"
                >Brand Name:</label
              >
              <input
                ...
                class="itbms-name input w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring focus:ring-blue-300"
              />
              <p
                class="text-red-500 itbms-message"
                v-if="validateBrandNameMassage"
              >
                {{ validateBrandNameMassage }}
              </p>
            </div>

            <div class="flex flex-col">
              <label for="websiteUrl" class="text-sm font-semibold mb-1"
                >Website URL:</label
              >
              <input
                ...
                class="itbms-websiteUrl input w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring focus:ring-blue-300"
              />
              <p
                class="text-red-500 itbms-message"
                v-if="validateBrandUrlMassage"
              >
                {{ validateBrandUrlMassage }}
              </p>
            </div>

            <div class="flex flex-col">
              <label for="isActive" class="text-sm font-semibold mb-1"
                >Is Active:</label
              >
              <input
            ...
            <div class="flex flex-col">
              <label for="country" class="text-sm font-semibold mb-1"
              ...
              <input
                ...
                class="itbms-countryOfOrigin input w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring focus:ring-blue-300"
              />
              <p
                class="text-red-500 itbms-message"
                v-if="validateBrandCountryMassage"
              >
                {{ validateBrandCountryMassage }}
              </p>
            </div>
            ...
            <div class="flex justify-center mt-6">
              <button
                ...
                :class="
                  !enableAddButton
                    ? 'itbms-save-button px-6 py-2 mr-2 bg-gray-400 text-white rounded-lg cursor-not-allowed'
                    : 'itbms-save-button cursor-pointer px-6 py-2 mr-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-300'
                "
              >
                Save
              </button>
              <button
                ...
                :class="
                  !enableEditButton
                    ? 'itbms-save-button px-6 py-2 mr-2 bg-gray-400 text-white rounded-lg cursor-no-drop'
                    : 'itbms-save-button cursor-pointer px-6 py-2 mr-2 bg-[#523F31] text-white rounded-lg hover:opacity-80 focus:outline-none focus:ring focus:ring-blue-300'
                "
              >
                Edit
              </button>
