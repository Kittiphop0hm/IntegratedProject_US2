...
const defaultImage =
  import.meta.env.BASE_URL + "images/carbon_no-image-gray.png";
...
<template>
  ...
  >
    <div class="w-[90%] rounded-2xl shadow-2xl p-6 bg-[#9D8A7C]">
      <div
        class="container bg-[#9D8A7C] mx-auto px-6 mt-10 mb-10 p-5 rounded-lg"
      >
        <router-link :to="{ name: 'SaleItemHome' }">
          <div class="w-20 h-15">
            <div
              class="w-full h-full flex justify-center items-center bg-gradient-to-r from-[#523F31] to-[#B88D6E] shadow-black shadow-[0_4px_6px_rgba(0,4,4,0)] rounded-lg cursor-pointer hover:opacity-80"
            >
              <svg
              ...
              >
                <path
                  fill="#ffffff"
                  fill-rule="evenodd"
                  d="m1.307 5.988l5.309-4.645c.411-.41.891-.479 1.302-.068v3.132l.229-.001c5.016 0 8.738 3.563 8.738 8.41c0 1.688-.774 1.073-1.097.484c-1.522-2.78-4.197-4.677-7.681-4.677l-.19.001v3.065c-.411.41-.941.361-1.302.068L1.306 7.474a1.052 1.052 0 0 1 .001-1.486z"
                />
              </svg>
            </div>
          </div>
        ...
        <div
          class="w-[40%] max-lg:w-full bg-[#523F31] shadow-black shadow-[0_4px_6px_rgba(0,4,4,0)] rounded-lg font-semibold bg-opacity-70 p-4 mb-4 mt-7"
        >
          <p class="text-white">
            <router-link :to="{ name: 'SaleItemHome' }">
              <span class="itbms-home-button text-white hover:underline"
                >Home</span
              >
            </router-link>
            &gt;
        ...
        <div class="itbms-row flex flex-col lg:flex-row lg:space-x-10">
          <div class="lg:w-1/2">
            <div
              class="w-[500px] h-[290px] max-md:w-full flex justify-center items-center relative rounded-md p-2 shadow-black shadow-[0_4px_6px_rgba(0,4,4,0)] bg-white"
            >
              <img
            ...
            <div class="w-[500px] flex justify-center items-center">
              <div
                class="w-full text-center grid grid-cols-4 gap-2 mt-4 max-md:grid-cols-2"
              >
                <div
                ...
                >
                  ...
                  <img
                    :src="!pictures[0] ? defaultImage : pictures[0]"
                    alt="thumb 1"
                    class="w-[74px] h-[74px] mx-auto"
                  />
                </div>
                <div
                ...
                >
                  <!-- <button class="absolute top-0 right-1 text-red-500 font-bold cursor-pointer hover:opacity-70">X</button> -->
                  <img
                    :src="!pictures[1] ? defaultImage : pictures[1]"
                    alt="thumb 2"
                    class="w-[74px] h-[74px] mx-auto"
                  />
                </div>
                ...
                >
                  <!-- <button class="absolute top-0 right-1 text-red-500 font-bold cursor-pointer hover:opacity-70">X</button> -->
                  <img
                    :src="!pictures[2] ? defaultImage : pictures[2]"
                    alt="thumb 3"
                    class="w-[74px] h-[74px] mx-auto"
                  />
                </div>
