...
public class EmailService {
    ...
    //     http://intproj24.sit.kmutt.ac.th/us2/new-password?token=%s
    public void sendEmail(String to, String token) {
        ...
        String messageBody = """
                 ...
                 https://intproj24.sit.kmutt.ac.th/us2/verify-email?token=%s
                """.formatted(token);
    ...
    public void sendEmailForgotPassword(String to, String token) {
        ...
        String messageBody = """
                 ...
                 https://intproj24.sit.kmutt.ac.th/us2/new-password?token=%s
                """.formatted(token);
        message.setText(messageBody);
        mailSender.send(message);
    }
