...
//                .authorizeHttpRequests( (request) -> request.anyRequest().permitAll())
                .authorizeHttpRequests( request -> request
                                ...
                                .requestMatchers(HttpMethod.PUT,"/v2/sale-items/**").hasAnyAuthority("SELLER")
                                .requestMatchers(HttpMethod.DELETE,"/v2/sale-items/**").hasAnyAuthority("SELLER")
...
//                .cors(withDefaults())
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:5173","https://intproj24.sit.kmutt.ac.th","http://localhost:4173"));
